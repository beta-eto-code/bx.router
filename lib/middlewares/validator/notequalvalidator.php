...
class NotEqualValidator extends BaseValidator
{
    ...
    public static function fromBody(array $values, string ...$fieldNames): NotEqualValidator
    {
    ...
    public static function fromHeaders(array $values, string ...$headerNames): NotEqualValidator
    {
        return new NotEqualValidator(
            $values,
            false,
    ...
    public static function fromAttributes(array $values, string ...$attributeNames): NotEqualValidator
    {
        return new NotEqualValidator(
            $values,
            false,
    ...
    public function withStrictMode(): NotEqualValidator
    {
